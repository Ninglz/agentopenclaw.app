...
export function Navbar({ scroll = true }: NavBarProps) {
  ...
  return (
    ...
    >
      {showBarBg && (
        <div
          className="absolute inset-0 z-0 bg-background/80 backdrop-blur-xl border-b border-border/50"
          aria-hidden="true"
        />
      )}
      <div className="relative z-10">
        <Container className="px-4">
          ...
          >
            ...
            >
              <Logo className="opacity-100 dark:opacity-90 group-hover:opacity-100 group-hover:scale-[1.05] transition-all" />
              <span className="text-sm font-heading font-black italic uppercase tracking-tighter text-foreground group-hover:text-primary transition-all">
                {t('Metadata.name')}
              </span>
            </LocaleLink>
                  ...
                  item.items ? (
                    ...
                    <NavigationMenuItem key={item.title}>
                      ...
                      >
                        <LocaleLink
                          href={item.href || '#'}
                          className="text-[11px] font-mono font-black uppercase tracking-[0.2em] transition-all hover:text-primary"
